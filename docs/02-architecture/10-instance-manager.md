# **Chapter 10 — Instance Manager**

## **10.1 Purpose of the Instance Manager**
...
## **10.2 The Lifecyle of Entity Creation**
...
## **10.3 Template Selection (CMP → ETY)**
...
## **10.4 Assigning the Sacred Codes**

### **10.4.1 DNA_ID — The Ontological Identity**
...
### **10.4.2 STRUCTURE_ID — Coordinate of Existence**
...
### **10.4.3 BREADCRUMB_ID — Depth and Trajectory**
...
### **10.5.2 Load Specific Attributes (ATR)**
...
## **10.6 Logging the Creation (LOG Entry)**
...
## **10.7 Instance Manager and the Entity Graph**
...
## **10.8 Special Case: Bootstrap Entities**
...
## **10.9 Guarantees of the Instance Manager**
